import { D as DevalueError, i as is_primitive, g as get_type, a as is_plain_object, e as enumerable_symbols, s as stringify_key, b as stringify_string, v as valid_array_indices, c as DEV, u as uneval, n as noop, d as safe_not_equal } from './chunks/index-BFvLoYgI.js';
...
<html lang="en">
	<head>
		...
		` + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover" class="bg-[#fafaf9] text-gray-900 antialiased font-serif">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n",
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-D82wHYRu.js'));
  let reroute;
  let transport;
  return {
    handle,
