	...
	{#each works as work, i}
		<div class="flex items-start gap-1">
			<textarea
				...
				class="flex-1 px-3 py-2 text-m border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all placeholder:text-gray-500 min-h-[80px] resize-y"
			...
			<div class="flex flex-col gap-1">
				<button
					type="button"
					class="w-7 h-7 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors flex items-center justify-center text-m font-sans font-bold"
				...
				<button
					type="button"
					class="w-7 h-7 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-colors flex items-center justify-center text-m font-serif italic font-bold"
